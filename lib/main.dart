...
import 'package:assignment2_shreyapatel/map.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: const Text('Assignment 2 - Shreya Patel'),
        ),
        body: ListView(
          children: [
            Image.asset(
...
void Route(){
  Mapslauncher.openMap(46.4989, 7.7291);
}
void share() {
  Share.share('Copy the location to share or select from the options below');
}